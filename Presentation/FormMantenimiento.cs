...
namespace Presentation
{
    public partial class FormMantenimiento : Form
    {
        ...
        {
            // Llamar al método para cargar empleados del área "Mantenimiento"
        ...
        // Método para cargar los empleados del área "Mantenimiento"
        private void CargarEmpleadosMantenimiento()
        {
            try
            {
                ...
                // Llamar al método para obtener empleados del área "Mantenimiento"
                DataTable empleados = dao.ObtenerEmpleadosPorArea("Mantenimiento");
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error al cargar los empleados del área Mantenimiento: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

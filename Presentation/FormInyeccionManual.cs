...
namespace Presentation
{
    public partial class FormInyeccionManual : Form
    {
        ...
        private void FormInyeccionManual_Load(object sender, EventArgs e)
        {
            // Llamar al método para cargar empleados del área "Inyección Manual"
            CargarEmpleadosInyeccionManual();
            ConfigurarDataGridView();
            PersonalizarDataGridView();
            this.dataGridViewEmpleados.CellContentClick += dataGridViewEmpleados_CellContentClick;
        }

        // Método para cargar los empleados del área "Inyección Manual"
        private void CargarEmpleadosInyeccionManual()
        {
            try
            {
                ...
                // Llamar al método para obtener empleados del área "Inyección Manual"
                DataTable empleados = dao.ObtenerEmpleadosPorArea("Inyeccion Manual");
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error al cargar los empleados del área Inyección Manual: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

...
{
    public partial class FormEnsamble : Form
    {
        ...
        private void FormEnsamble_Load(object sender, EventArgs e)
        {
            // Llamar al método para cargar empleados del área "Ensamble"
            CargarEmpleadosEnsamble();
            ConfigurarDataGridView();
            PersonalizarDataGridView();
            this.dataGridViewEmpleados.CellContentClick += dataGridViewEmpleados_CellContentClick;
        }

        // Método para cargar los empleados del área "Ensamble"
        private void CargarEmpleadosEnsamble()
        {
            try
            {
                ...
                // Llamar al método para obtener empleados del área "Ensamble"
                DataTable empleados = dao.ObtenerEmpleadosPorArea("Ensamble");
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error al cargar los empleados del área Ensamble: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

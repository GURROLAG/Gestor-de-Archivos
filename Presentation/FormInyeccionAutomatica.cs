...
namespace Presentation
{
    public partial class FormInyeccionAutomatica : Form
    {
        ...
        private void FormInyeccionAutomatica_Load(object sender, EventArgs e)
        {
            // Llamar al método para cargar empleados del área "Inyección Automática"
            PersonalizarDataGridView();
            CargarEmpleadosInyeccionAutomatica();
            ConfigurarDataGridView();
            this.dataGridViewEmpleados.CellContentClick += dataGridViewEmpleados_CellContentClick;
        }

        // Método para cargar los empleados del área "Inyección Automática"
        private void CargarEmpleadosInyeccionAutomatica()
        {
            try
            {
                ...
                // Llamar al método para obtener empleados del área "Inyección Automática"
                DataTable empleados = dao.ObtenerEmpleadosPorArea("Inyeccion Automatica");
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error al cargar los empleados del área Inyección Automática: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

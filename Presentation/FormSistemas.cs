...
namespace Presentation
{
    public partial class FormSistemas : Form
    {
        ...
        public FormSistemas()
        {
            ...
            CargarEmpleadosEnDataGrid("Sistemas");  // Cargar empleados de la área "Sistemas"
        ...
        private void FormSistemas_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void dataGridViewEmpleados_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridViewEmpleados.Columns[e.ColumnIndex].Name == "VerDetalles")
            {
                ...
                else
                {
                    ...
                    MessageBox.Show("El ID del empleado no está disponible.");
                }
            }
        }

...
namespace Presentation
{
    public partial class FormChoferes : Form
    {
        ...
        {
            // Llamar al método para cargar empleados del área "Choferes"
            CargarEmpleadosChoferes();
            PersonalizarDataGridView();
            ConfigurarDataGridView();
            this.dataGridViewEmpleados.CellContentClick += dataGridViewEmpleados_CellContentClick;
        }

        // Método para cargar los empleados del área "Choferes"
        private void CargarEmpleadosChoferes()
        {
            try
            {
                ...
                // Llamar al método para obtener empleados del área "Choferes"
                DataTable empleados = dao.ObtenerEmpleadosPorArea("Choferes");
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error al cargar los empleados del área Choferes: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
